			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('allcourses.index')}}">Courses</a></li>
							<li><a class="slide-item" href="{{route('language.index')}}">Languages</a></li>
							<li><a class="slide-item" href="{{route('allteam.index')}}">Team</a></li>
							<li><a class="slide-item" href="{{route('message.index')}}">Contact</a></li>
							<li><a class="slide-item" href="{{route('data.index')}}">Home</a></li>
							<li><a class="slide-item" href="{{route('message.index')}}">ways of learning</a></li>
							<li><a class="slide-item" href="">gallary</a></li>

							<li><a class="slide-item"<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
